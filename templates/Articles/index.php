...
<div class="articles index content">
    <?= $this->Html->link(__('Nuevo Articulo'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Articulos') ?></h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $article->id], ['confirm' => __('Are you sure you want to delete # {0}?', $article->id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
